...
"}"));
        ...
        widget->setStyleSheet(QLatin1String("QTabWidget QWidget\n"
"{\n"
...
"}"));
        ...
        tab_3->setStyleSheet(QLatin1String("QTabWidget QWidget\n"
"{\n"
"background-color:rgb(29, 29, 29);\n"
"}"));
        ...
        tab_4->setStyleSheet(QLatin1String("QTabWidget QWidget\n"
"{\n"
"background-color:rgb(29, 29, 29);\n"
"}"));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Auto-Ctrl", nullptr));
