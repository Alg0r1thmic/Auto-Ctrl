...
main(){
	vector<int> capas = {2,1};
	Network red(capas);
	vector<vector<double>> train1 = {{9.2,4.7},{8.0,4.5},{6.0,4.0},{5.0,5.0},{10.0,5.0},{10.5,4.0},{10.0,6.8},{8.0,5.0},{12.0,10.0},{9.5,6.0},{6.2,7.7}};
	vector<vector<double>> train2 = {{0.51},{0.56},{0.66},{1.0},{0.2},{0.38},{0.68},{0.625},{0.833},{0.631},{1.241}};

	red.Aprendizaje_Prop_Atras(train1,train2);
	red.Mostrar_Pesos();
	for(int i = 0; i < train1.size(); ++i){
		red.Calcular_Output(train1[i]);
		red.Mostrar_Output();
	}
}
